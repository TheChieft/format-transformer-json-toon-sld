...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 transition-colors duration-300">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center space-y-6 mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Convert between JSON, TOON, and SLD formats. Save tokens, reduce costs, 
              and optimize your AI prompts with intelligent data serialization.
            </p>
          ...
          <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4 p-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">Real-time Sync</h3>
              <p className="text-gray-600 dark:text-gray-400">
                Edit any format and watch all three update instantly. No manual conversion needed.
              </p>
            </div>
            ...
            <div className="text-center space-y-4 p-6">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                See character count, token estimates, byte size, and readability scores for each format.
              </p>
            </div>
      ...
      <div ref={howItWorksRef} className="relative bg-white dark:bg-gray-800 transition-colors duration-300">
        <HowItWorksSection />
      </div>
      ...
      <footer className="bg-gray-900 dark:bg-black text-white py-12 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="space-y-4">
              ...
              <p className="text-gray-400 text-sm">
                Open-source tool for converting data between AI-optimized formats. 
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li>
                  <a href="https://github.com/TheChieft/format-transformer-json-toon-sld" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                    GitHub
                  </a>
                </li>
              </ul>
          ...
          <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
            <p>
              Built with ❤️ for the AI community • Open Source • MIT License
            </p>
          </div>
        </div>
      </footer>
