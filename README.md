...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/TheChieft/format-transformer-json-toon-sld)
...
**Important**: Remove the `base` property from `vite.config.ts` for Vercel deployment:
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/TheChieft/format-transformer-json-toon-sld)
...
**Important**: Same as Vercel, remove the `base` property from `vite.config.ts`.

### Deploy to GitHub Pages (Current Setup)

This repository is already configured for GitHub Pages deployment via GitHub Actions.
...
4. Visit: `https://yourusername.github.io/format-transformer-json-toon-sld/`
